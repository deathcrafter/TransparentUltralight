...
public:
	...
	Surface* CreateSurface(uint32_t width, uint32_t height) { return new DIBSurface(window_dc_, width, height); }

	void DestroySurface(Surface* surface) { delete static_cast<DIBSurface*>(surface); }
